...
class LandlordResidentialPricing extends Component {
 constructor(props) {
    super(props);
				...
				<div className="breadcrumb-section">
					 <nav aria-label="breadcrumb">
						<ul className="breadcrumb">
							...
							<li className="breadcrumb-item">Landlord Residential</li>
						</ul>
					</nav> 
				</div>
				<div className="pricing-contents">
				  <div className="pricing-title text-center">
					<h3>Residential Package Details for Landlord</h3>
...
export default LandlordResidentialPricing;
