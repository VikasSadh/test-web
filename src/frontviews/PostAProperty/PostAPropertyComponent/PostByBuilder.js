...
class PostByBuilder extends Component {
 constructor(props) {
    super(props);
 }
render() {  
	return (
		<div className="builder postproperty-name">
      <form>
        ...
        <div className="postproperty-row second-row">                
          <div className="form-group">
            <div className="row">
              <div className="col-md-6 nr-padding">
                <div className="form-fields">
                  <input type="text" placeholder="Builder Name" className="form-control" />
                </div>
              </div>
              <div className="col-md-6 nl-padding">
                <div className="form-fields">
