...
class EditIndividualUserModal extends Component {
 constructor(props) {
    super(props);
		this.state = { fields: {}, errors: {},user_id:'' ,stateoption:[], cityoption:[],stateandcityoption:[],user_area:'',loadingp: false, suggestions: [],vaild_mobileno:'',vaild_emailid:'' }
      ...
      <div className="animated fadeIn">
        <Row>
			 <Col>
                ...
                <Modal isOpen={this.props.isOpen} toggle={this.toggleedit} className={'modal-lg'}>
                  <ModalHeader toggle={this.toggleedit}>Edit Individual User </ModalHeader>
                  <ModalBody>
								<Row>
          <Col xs="12" sm="12">
            <Card>
			<Form id="edit_individualuser_form" method="post"  name="UserForm"  onSubmit={this.handleSubmit}>
              <CardBody >
                ...
                <Row>
				  ...
				  <Col md="6">
                    ...
                    <FormGroup>
                      ...
                      <Input readOnly type="text" id="name" placeholder="Enter your name" maxlength={30} name="user_name" value={this.state.fields.user_name} onChange={this.handleChange}  />
                    </FormGroup>
                ...
                <Row>
				  <Col md="6">
                    <FormGroup>
                      ...
                      <Input readOnly type="text"  id="mobile" placeholder="Enter mobile no" maxlength={10} name="user_mobileno" value={this.state.fields.user_mobileno} onChange={this.handleChange}  />
...
export default EditIndividualUserModal;
