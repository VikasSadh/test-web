...
class GoLiveRentalPropertyList extends Component {
constructor(props) {
		super(props);
...
let $this  = this;
	...
	axios.post(API_URL+'/api/admin/getgolive_rentalpropertylist').then(function(response){
          ...
          <Col lg={12}>
            <Card className="users-pg">
              <CardHeader>
                ...
                <strong><i className="icon-list pr-1"></i>Live Property List</strong>
              </CardHeader>
              <CardBody>
...
export default GoLiveRentalPropertyList;
