...
class AssignRolesList extends Component {
        ...
        <Row>
          <Col lg={12}>
            <Card className="users-pg">
              <CardHeader>
			  <Link to="/ez-admin/add-assign-roles"> <Button color="primary" className="px-4"><i className="fa fa-plus"></i> Add</Button></Link>
                <strong><i className="icon-info pr-1"></i>Assign Roles List</strong>
              </CardHeader>
              <CardBody>
